...
* This document describes the process of extracting the landuse/landcover (LULC) data for the 2007 National Lake Assessment Sites.
...
#can also retrieve the data definitions
data_def[147,]
