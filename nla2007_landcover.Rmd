...
* This document ([nla2007_landcover.rmd](https://github.com/willbmisled/OddAndEnds/blob/master/nla2007_landcover.Rmd)) describes the process of extracting the landuse/landcover (LULC) data for the 2007 National Lake Assessment Sites.
...
write.csv(lulc,'nla_2007_landcover.csv')
