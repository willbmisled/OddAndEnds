...
* This document ([nla2007_census.rmd](https://github.com/willbmisled/OddAndEnds/blob/master/nla2007_census.Rmd)) describes the process of extracting the 2000 census data for the 2007 National Lake Assessment Sites.
