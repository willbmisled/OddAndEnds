...
##############################
https://www.dropbox.com/sh/pnc72j0rbvtw38c/AAB55cPyB0S3pv6cd6QDgLjDa?dl=0

mtcars<-read.csv("https://www.dropbox.com/s/7xg5u0z1gtjcuol/mtcars.csv?dl=1")
write.csv('https://www.dropbox.com/sh/pnc72j0rbvtw38c/AAB55cPyB0S3pv6cd6QDgLjDa?dl=0.mtcars.csv')
