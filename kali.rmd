...
* to restart an restudio session on kali:
    ...
    - This will show the active processes in rstudio.  From this find the rstudio process you want to stop.  The five digit number in the second field is the process id. 
